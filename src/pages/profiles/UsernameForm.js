...
const UsernameForm = () => {
    ...
    useEffect(() => {
        // since the profile id is an integer, and the param id is a string, we need to convert the integer into a string using the toString() method before we can check that they are equal.
